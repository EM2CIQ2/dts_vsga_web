    ...
    <div class="row justify-content-center">
        <div class="col-md-6 shadow-lg p-3 bg-success rounded" id="form-register">
            ...
            <form action="edit.php" method="POST" onsubmit="return validate()">
                ...
                <input type="text" name="id" id="id" class="form-control" value="<?= $siswa['KodeBarang'] ?>" hidden>
                <div class="form-group">
                    <input type="text" name="nama" id="nama" class="form-control" value="<?= $siswa['NamaBarang'] ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="price" id="price" class="form-control" value="<?= $siswa['HargaBarang'] ?>">
                </div>
                <div class="row">
                    <div class="col-sm-6">
